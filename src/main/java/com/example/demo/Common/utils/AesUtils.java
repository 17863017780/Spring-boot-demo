...
//import com.magicscreen.app.server.common.constant.CommonConstants;
...
public class AesUtils {
    ...
    private static final Log logger = LogFactory.getLog(AesUtils.class); // log日志
    ...
    public static String enCode(String content, String key) {
        ...
        try {
            ...
            return Base64.encodeBase64String(Base64.encodeBase64URLSafe(encode_content)); // 将加密后的数据转换为字符串返回
        } catch (Exception e) {
    ...
    public static String deCode(String content, String key) {
        ...
        try {
            ...
            byte[] encode_content = Base64.decodeBase64(Base64.decodeBase64(content)); // 把密文字符串转回密文字节数组
    ...
    public static void main(String[] args) {
        ...
        System.out.println(BigDecimal.ZERO.equals(a));
        int b = BigDecimal.ZERO.compareTo(a);
    }
}
